...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/artigo/artigodettalhe", "/artigo/artigolista", "/autorizarroleapi", "/salvaloginapi",
            "/artigo/artigo", "/artigo/artigoconta", "/getparticipantes", "/selecionaperfil", "/adiconaparticipantenovo", "/noticia/lista", "/blog/login/**").permitAll();        
